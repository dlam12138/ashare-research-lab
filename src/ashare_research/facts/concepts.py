...
class ConceptRegistry:
    ...
    CONCEPTS: dict[str, Concept] = {
        ...
        "net_profit_attributable_to_parent": Concept(
        ...
        "net_profit_excluding_non_recurring": Concept(
        ...
        "cash_paid_for_fixed_assets": Concept(
        ...
        "cash_paid_for_intangible_assets": Concept(
        ...
        "cash_paid_for_long_term_assets": Concept(
        ...
        "capital_expenditure_cash": Concept(
        ...
        "net_cash_from_financing": Concept(
        ...
        # ── 资产负债表（时点值） ──
        "cash_and_cash_equivalents": Concept(
        ...
        "total_current_liabilities": Concept(
        ...
        "equity_attributable_to_parent": Concept(
        ...
        "cash_dividend_per_share": Concept(
        ...
        "ownership_increase_amount": Concept(
    ...
    def get(cls, concept_id: str) -> Concept | None:
        """按 ID 获取概念定义。"""
        return cls.CONCEPTS.get(concept_id)

    @classmethod
    def get_by_category(cls, category: ConceptCategory) -> list[Concept]:
        """获取指定分类下所有概念。"""
        return [
            c for c in cls.CONCEPTS.values()
