...
def run_synthetic(
    ...
    contracts = [
        load_json_contract("m3_stage3ca_analysis_pipeline_contract_v1.json"),
        load_json_contract("m3_stage3ca_model_specification_v1.json"),
        load_json_contract("m3_stage3ca_robustness_registry_v1.json"),
        load_json_contract("m3_stage3ca_output_schema_v1.json"),
    ]
    ...
    model_digest, model_payload = build_model_digest(
        ...
        contract_paths=[contract_path(name) for name in (
            "m3_stage3ca_analysis_pipeline_contract_v1.json",
            "m3_stage3ca_model_specification_v1.json",
            "m3_stage3ca_robustness_registry_v1.json",
            "m3_stage3ca_output_schema_v1.json",
        )],
        source_paths=_source_paths(),
        dependency_contract={"statsmodels": ">=0.14.6,<0.15", "numpy_rng": "PCG64"},
        upstream_contract_identities=contracts[0]["frozen_upstream_contract_identities"],
    )
    ...
    primary = {
        "model_id": "M3_STAGE3CA_PETROCHINA_CRASH_CONTROL_OLS_V1",
        "model_digest": model_digest,
    ...
    result = {
        "status": "M3_STAGE3CA_PIPELINE_LOCK_ACCEPTED",
        "status_tokens": [
