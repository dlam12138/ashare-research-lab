...
- FY2024 `nopat.lease_interest_expense` / `lease_interest_expense`: **missing_official_fact** (canonical_concept_absent_for_fiscal_year)
...
- FY2024 `nopat.investment_income` / `investment_income`: **missing_official_fact** (canonical_concept_absent_for_fiscal_year)
...
- FY2024 `nopat.fair_value_net_change` / `fair_value_net_change`: **missing_official_fact** (canonical_concept_absent_for_fiscal_year)
...
- FY2024 `nopat.asset_disposal_gain_loss` / `asset_disposal_gain_loss`: **missing_official_fact** (canonical_concept_absent_for_fiscal_year)
...
- FY2023 `invested_capital.non_controlling_interest` / `non_controlling_interest`: **missing_official_fact** (canonical_concept_absent_for_fiscal_year)
- FY2024 `invested_capital.non_controlling_interest` / `non_controlling_interest`: **missing_official_fact** (canonical_concept_absent_for_fiscal_year)
