...
1. **个股价值评估** — 企业质量、估值吸引力、价值兑现能力、风险否决项（尚未实现）
2. **市场机制验证** — 用统计方法检验个股与市场之间的可复现关系（尚未实现）

当前已完成第一阶段的**免费数据底座**：可运行、可测试、可追溯的本地数据基础设施。
...
本阶段（免费数据底座 MVP）的已知限制：

- 仅支持日线数据，不支持分钟数据
- 未实现财务数据
- 未实现行业数据、商品数据、宏观数据
- 未实现点时（point-in-time）财务数据对齐
- 未实现价值评估和机制验证模块
...
| Milestone 2: 价值评估 MVP | 企业质量、估值、现金流、安全边际、风险否决项 | 🔲 计划中 |
